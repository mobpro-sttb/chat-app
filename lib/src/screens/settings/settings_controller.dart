...
class SettingsController extends StateControl {
  ...
  openModalDeleteChats() {
    String title = "Hapus percakapan";
    String description =
        "Yakin akan menghapus percakapan? percakapan tidak dapat dikembalikan.";
    List<Widget> actions = [
      FlatButton(
        child: Text(Platform.isIOS ? 'Batal' : 'BATAL'),
        onPressed: () {
  ...
  deleteChats() async {
    ...
    String description = "Percakapan telah dihapus.";
    List<Widget> actions = [
      FlatButton(
  ...
  openModalExitApp() {
    String title = "Keluar";
    String description = "Yakin untuk keluar?";
    List<Widget> actions = [
      FlatButton(
        child: Text(Platform.isIOS ? 'Batal' : 'BATAL'),
        onPressed: () {
